package net.wly.pro.generator.utils;
...
import net.wly.pro.common.utils.DateUtils;
import net.wly.pro.common.utils.JdbcUtils;
import net.wly.pro.common.utils.PropertiesUtils;
import net.wly.pro.generator.constant.GenConstant;
...
public class JdbcGenUtils {
	...
	public static void main(String[] args) throws Exception {
		...
		String jdbcUrl = "jdbc:mysql://192.168.2.18:3300/wly_pro?useUnicode=true&characterEncoding=utf-8";
		String jdbcUsername = "root";
		String jdbcPassword = "cykj2016";
		...
		generatorCode(jdbcDriver, jdbcUrl, jdbcUsername, jdbcPassword, tablePrefix, javaProject, webProject, javaModule,
				webModule);

	}

	public static void generatorCode(String jdbcDriver, String jdbcUrl, String jdbcUsername, String jdbcPassword,
			String tablePrefix, String javaProject, String webProject, String javaModule, String webModule)
			throws Exception {
		...
		for (TableEntity tableEntity : tables) {
			...
			for (String template : GenUtils.getTemplates()) {
				String filePath = getFileName(template, javaProject, webProject, javaModule, webModule,
						table.getClassName());
	...
	public static String getFileName(String template, String javaProject, String webProject, String javaModule,
			String webModule, String className) {
		String packagePath = getProjectPath(javaProject) + "/src/main/java/"
				+ PropertiesUtils.getInstance("generator").get("package").replace(".", "/") + "/" + javaModule + "/";
		String resourcePath = getProjectPath(javaProject) + "/src/main/resources/"
				+ PropertiesUtils.getInstance("generator").get("package").replace(".", "/") + "/" + javaModule + "/";
